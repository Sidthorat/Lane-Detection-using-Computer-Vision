# -*- coding: utf-8 -*-
"""
Created on Mon Aug  1 15:58:41 2022
...
def region_of_interest(image):
    ...
    polygons = np.array([
    [(200, height), (1500, height), (550,250)]
    ])
...
lines= cv2.HoughLinesP(cropped_image, 2,np.pi/180, 100, np.array((1)), minLineLength=40, maxLineGap=5) 
